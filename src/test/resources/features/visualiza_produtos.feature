...
Funcionalidade: Comprar produto
  ...
  Esquema do Cenario: Deve mostrar produto escolhido confirmado
    ...
    E preco do produto na tela principal e na tela do produto eh <precoProduto>
    E adiciono o produto no carrinho com tamamnho <tamanhoProduto> cor <corProduto> e quantidade <quantidadeProduto>
