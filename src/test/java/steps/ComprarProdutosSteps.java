...
//}
	...
	public void estou_logado() {
		// Clicar no botao SignIn na home page
	...
	@Quando("preco do produto na tela principal e na tela do produto eh {string}")
	...
	@Quando("adiciono o produto no carrinho com tamamnho {string} cor {string} e quantidade {int}")
	public void adiciono_o_produto_no_carrinho_com_tamamnho_cor_e_quantidade(String tamanhoProduto, String corProduto,
	...
	public void capturarTela(Scenario scenario) {
		...
		String nomeArquivo = "resources/screenshots/" + scenario.getName() + "_" + scenario.getId() + "_" + scenario.getStatus() + ".png";
